		...
		<>
			<div id='Contact' className='contact'>
				{((currntUrl && currntUrl === "http://localhost:5173/Contact") ||
					...
					currntUrl ===
						"https://inquisitive-croissant-516f39.netlify.app/Contact#FAQ") && (
					<>
						<NavBar />
					</>
				)}
                ...
                <input type="text" placeholder='e.g $250 - $350'/>
						...
						<div id='div-message' className='contact__form-input'>
							<label htmlFor='message'>
								<p>PLEASE TELL A BIT ABOUT YOURSELF & YOUR PROJECT</p>
							</label>
							<textarea
								name='message'
								id=''
						...
						<div id='div-select' className='contact__form-select'>
							<label htmlFor=''>
								<p>
									HOW WOULD YOU LIKE TO CONNECT <span>*</span>
								</p>
							</label>
							<select name='connect' id='' required>
					...
					{((currntUrl && currntUrl === "http://localhost:5173/Contact") ||
						currntUrl ===
							"https://inquisitive-croissant-516f39.netlify.app/Contact" ||
						currntUrl === "http://localhost:5173/Contact#FAQ" ||
						currntUrl ===
							"https://inquisitive-croissant-516f39.netlify.app/Contact#FAQ") && (
						<>
